...
const App = (props) => {
    ...
    const { data: privacyPolicy } = useQuery({
        ...
        queryFn: () => {
            return fetch(`http://localhost:3000/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/content/privacy-policy?client_id=264f0d69-a6b7-4001-a2df-20d025275702`)
    ...
    useEffect(() => {
        ...
        const fetchStore = async () => {
            const res = await fetch(
                `http://localhost:3000/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/stores?latitude=${GEO_LOCATION.lat}&longitude=${GEO_LOCATION.long}&client_id=264f0d69-a6b7-4001-a2df-20d025275702`
            )
            if (res.ok) {
